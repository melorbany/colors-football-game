...
public class RevMobIos : RevMob {
	...
	[DllImport("__Internal")]
	private static extern void RevMobUnityiOSBinding_showBasicBanner(ScreenOrientation[] orientations);

	[DllImport("__Internal")]
	private static extern void RevMobUnityiOSBinding_hideBasicBanner();

	[DllImport("__Internal")]
	private static extern void RevMobUnityiOSBinding_releaseBasicBanner();
	...
	public override void ShowBanner(ScreenOrientation[] orientations){
		RevMobUnityiOSBinding_showBasicBanner(orientations);
	}
	public override void HideBanner(){
		RevMobUnityiOSBinding_hideBasicBanner();
	}

	public override void ReleaseBanner(){
		RevMobUnityiOSBinding_releaseBasicBanner();
	}
